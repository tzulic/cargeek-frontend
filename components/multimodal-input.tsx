  ...
  return (
    <div className="flex relative flex-col gap-4 w-full">
      ...
      <PromptInput
        ...
        onSubmit={(event) => {
          event.preventDefault();
          // Allow new messages immediately - concurrent requests are supported
          // The AI SDK Data Stream Protocol handles multiple concurrent conversations
          submitForm();
        }}
      >
...
function PureAttachmentsButton({
  ...
  return (
    <Button
      ...
      disabled={false} // Allow file uploads anytime
      variant="ghost"
    >
